...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        nearestTimer = new QVBoxLayout();
        nearestTimer->setObjectName("nearestTimer");
        timerTime = new QLabel(centralwidget);
        timerTime->setObjectName("timerTime");
        QSizePolicy sizePolicy2(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(timerTime->sizePolicy().hasHeightForWidth());
        timerTime->setSizePolicy(sizePolicy2);
        timerTime->setMinimumSize(QSize(0, 0));
        QFont font2;
        font2.setFamilies({QString::fromUtf8("JetBrains Mono NL")});
        font2.setPointSize(50);
        font2.setStyleStrategy(QFont::PreferAntialias);
        timerTime->setFont(font2);
        timerTime->setFocusPolicy(Qt::NoFocus);
        timerTime->setAlignment(Qt::AlignCenter);

        nearestTimer->addWidget(timerTime);


        horizontalLayout->addLayout(nearestTimer);
