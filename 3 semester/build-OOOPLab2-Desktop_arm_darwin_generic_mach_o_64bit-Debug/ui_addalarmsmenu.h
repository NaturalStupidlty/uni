...
public:
    ...
    QLineEdit *findSoundPath;
    QPushButton *findSoundButton;
    ...
    void setupUi(QDialog *addAlarmsMenu)
    {
        ...
        frame_4->setMaximumSize(QSize(16777215, 350));
        ...
        Sound = new QLabel(frame_4);
        Sound->setObjectName("Sound");
        QFont font3;
        font3.setFamilies({QString::fromUtf8("Montserrat")});
        font3.setPointSize(36);
        Sound->setFont(font3);
        Sound->setAlignment(Qt::AlignCenter);

        verticalLayout_4->addWidget(Sound);
        ...
        findSoundPath = new QLineEdit(frame_4);
        findSoundPath->setObjectName("findSoundPath");
        QSizePolicy sizePolicy2(QSizePolicy::Expanding, QSizePolicy::Minimum);
        sizePolicy2.setHorizontalStretch(0);
        sizePolicy2.setVerticalStretch(0);
        sizePolicy2.setHeightForWidth(findSoundPath->sizePolicy().hasHeightForWidth());
        findSoundPath->setSizePolicy(sizePolicy2);
        findSoundPath->setMinimumSize(QSize(0, 30));
        QFont font4;
        font4.setFamilies({QString::fromUtf8("Montserrat")});
        font4.setPointSize(18);
        findSoundPath->setFont(font4);
        findSoundPath->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);

        horizontalLayout_9->addWidget(findSoundPath);

        findSoundButton = new QPushButton(frame_4);
        findSoundButton->setObjectName("findSoundButton");
        findSoundButton->setMaximumSize(QSize(16777215, 35));
        QFont font5;
        font5.setFamilies({QString::fromUtf8("Montserrat")});
        font5.setPointSize(14);
        findSoundButton->setFont(font5);

        horizontalLayout_9->addWidget(findSoundButton);
    ...
    void retranslateUi(QDialog *addAlarmsMenu)
    {
        ...
        Sound->setText(QCoreApplication::translate("addAlarmsMenu", "\320\227\320\262\321\203\320\272 ", nullptr));
        findSoundPath->setText(QCoreApplication::translate("addAlarmsMenu", "\320\227\320\260 \320\267\320\260\320\274\320\276\320\262\321\207\321\203\320\262\320\260\320\275\320\275\321\217\320\274", nullptr));
        findSoundButton->setText(QCoreApplication::translate("addAlarmsMenu", "\320\227\320\275\320\260\320\271\321\202\320\270", nullptr));
